...
$api_params = array("mid"=>"5","smid"=>"3","userId"=>$userid, "status" => "1","hierarchy"=>"true");


$adv_api_params = array("mid"=>"5","smid"=>"3","userId"=>$userid, "status" => "1","hierarchy"=>"true");
