...
$column_listing = array(
	 ...
	 array("column_heading"=>"formid","column"=>"jobId","searching"=>"false","sorting"=>"false","adv_searching"=>"false"),
    array("column_heading"=>"form_name","column"=>"title","searching"=>"false","sorting"=>"false","adv_searching"=>"false"),
    array("column_heading"=>"creator","column"=>"creator_name","searching"=>"false","sorting"=>"false","adv_searching"=>"false"),
	array("column_heading"=>"fill_date","column"=>"date","searching"=>"false","sorting"=>"false","adv_searching"=>"false")
...
$api_params = array("userId"=>$userId,"mid"=>"5","smid"=>"3","hierarchy"=>'true');

$adv_api_params = array("userId"=>$userId,"smid"=>"3");
...
$json_data = array(
	'feedbackfromList' => array(
            'template' => 'feedbackform',
            'templatePath' => 'extensions/feedback_form/templates/admin/common_templates/',
            'language' => 'en',
            'page_heading' => 'Feedback Form',
            
            'advanced_search' => array('status' => 'true','adv_call_func'=>'','adv_callBack_func'=>'', 'template' => 'default', 'api_action' => 'get_feedback_jobs','query_type'=>'mysql','page_heading' => 'advanced_search','div_class'=>'row','div_id'=>'stadd','search_equivalent'=>array('$eq','$gt','<','>=','<=','!=','like'),'adv_search_col_listing'=>$adv_search_col_listing,"api_params"=>$adv_api_params),

            'listing_details' => array('status' => 'true','sorting'=>false,'default_column_order'=>array(0,'desc'),'default_call_func'=>'','default_callBack_func'=>'hello','div_id'=>'employee-grid','column_setting'=>'true','file_includes'=>"true",'data_handle'=>'true', 'template' => 'default', 'export_csv' => 1,'custom_buttons'=>'true','custom_buttons_setting'=>$custom_buttons_setting, 'api_action' => 'get_feedback_jobs','searching'=>false,'serverSide'=>'false','processing'=>'true','page_heading' => 'form_wise_pending', 'columns_listing' => $column_listing,'request_params' => $request_params,"response_params"=>$response_params,'request_url_params' => $request_url_params,"extra_columns"=>$extra_columns,"api_params"=>$api_params)
	),
