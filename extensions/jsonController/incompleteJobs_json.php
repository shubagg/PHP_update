...
$column_listing = array(
	array("column_heading"=>"id","column"=>"jobId","searching"=>"false","sorting"=>"false","adv_searching"=>"false"),
	...
	array("column_heading"=>"date","column"=>"date","searching"=>"false","sorting"=>"false","adv_searching"=>"false"),
...
$api_params = array("mid"=>"5","smid"=>"3","status"=>"4","userId"=>$userid,"hierarchy"=>true);
...
$json_data = array(
	'incompleteJobs' => array(
            ...
            'advanced_search' => array('status' => 'true','adv_call_func'=>'','adv_callBack_func'=>'', 'template' => 'default', 'api_action' => 'get_adv_tickets','query_type'=>'mysql','page_heading' => 'advanced_search','div_class'=>'row','div_id'=>'stadd','search_equivalent'=>array('$eq','$gt','<','>=','<=','!=','like'),'adv_search_col_listing'=>$adv_search_col_listing,"api_params"=>$adv_api_params),
