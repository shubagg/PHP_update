...
$json_data = array(
	'rejectedApprovalFormjobs' => array(
            'template' => 'formjobs',
            'templatePath' => 'extensions/aintu_form_job/templates/admin/common_templates/',
            'language' => 'en',
            'page_heading' => 'tickets',
            
            'advanced_search' => array('status' => 'true','adv_call_func'=>'','adv_callBack_func'=>'', 'template' => 'default', 'api_action' => 'get_all_rejected_approvals','query_type'=>'mysql','page_heading' => 'advanced_search','div_class'=>'row','div_id'=>'stadd','search_equivalent'=>array('$eq','$gt','<','>=','<=','!=','like'),'adv_search_col_listing'=>$adv_search_col_listing,"api_params"=>$adv_api_params),
