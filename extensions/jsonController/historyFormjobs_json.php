...
$column_listing = array(
	array("column_heading"=>"id","column"=>"id","searching"=>"false","sorting"=>"true","adv_searching"=>"false"),
	array("column_heading"=>"request_by","column"=>"request_by_name","searching"=>"false","sorting"=>"false","adv_searching"=>"false"),
	array("column_heading"=>"request_by_comment","column"=>"request_by_comment","searching"=>"false","sorting"=>"false","adv_searching"=>"false"),
	array("column_heading"=>"request_status","column"=>"request_status","searching"=>"false","sorting"=>"false","adv_searching"=>"false"),
	array("column_heading"=>"request_by_dt","column"=>"request_by_dt","searching"=>"false","sorting"=>"false","adv_searching"=>"false"),
	array("column_heading"=>"request_to","column"=>"request_to_name","searching"=>"false","sorting"=>"false","adv_searching"=>"false"),
	array("column_heading"=>"action_comment","column"=>"action_comment","searching"=>"false","sorting"=>"false","adv_searching"=>"false"),
	array("column_heading"=>"action_status","column"=>"action_status","searching"=>"false","sorting"=>"false","adv_searching"=>"false"),
	array("column_heading"=>"action_dt","column"=>"action_dt","searching"=>"false","sorting"=>"false","adv_searching"=>"false")
...
$request_url_params = array("iid"=>"iid");

$api_params = array("mid"=>"5","smid"=>"3","id"=>0);
...
*/
$button = '<a name="approve" onclick="approve(<?php echo $column[id];?>)" id="approve" href="javascript:;"><?php echo $ui_string[approve] ?></a>/<a name="reject" onclick="reject(<?php echo $column[id];?>)" id="reject" href="javascript:;" ><?php echo $ui_string[reject] ?></a>';
