              ...
              <header class="panel-heading">
                  <div class="row">
                    <div class="col-md-4 margn_tp_7">
                        <h3><strong>Event ticket booked</strong> List</h3>
                    </div>
                    <div class="col-md-8">
                ...
                <div class="panel-body panel_bg_d">
                  <div class="table-responsive">
                                <?php 
                                   ...
                                   $column_head=array('checkbox','Image','Title','Detail','User','Booked on','Booked for','Payment Status');  
                                  $show_fields=array('checkbox','user_avatar','title','details','username','date','bookedfor','bookedStatus');
                                  $All_data=array("head"=>$column_head);
                                  $table_data=array("table_id"=>"data_table_1","table_data"=>$All_data);
                                  get_ajax_datatable($table_data,$show_fields,extensions_ui_url()."/events_and_venues/ui/admin/ajax/datatable_ajax_ticketbook.php"); 
...
<script type="text/javascript" src="<?php echo extensions_ui_url(); ?>/events_and_venues/ui/admin/js/ticket_book.js"></script>
