    					...
    					<header class="panel-heading">
        					<div class="row">
        						<div class="col-md-4 margn_tp_7">
        								<h3><strong>Event Organizer</strong> List</h3>
        						</div>
        						<div class="col-md-8">
          							<div class="text-right select_all tooltip-area btn-grp">
              		              
                  								 <button type="button" onclick="get_dataajax_data_organizer()" data-toggle="tooltip" data-placement="top" title="Refresh" class="btn btn-default"><i class="glyphicon glyphicon-refresh"></i></button>
            	          </div> 
        						</div>
        					</div>
    					</header>
    						...
    						<div class="panel-body panel_bg_d">
                                ...
                                <?php 
                                  ...
                                  $column_head=array('checkbox','Name Of Agency','Speciality In','Contact No.','Locaiton','Email','Action');  
                                  $show_fields=array('checkbox','name','speciality','mobile','adderss','email','action');
                                	$All_data=array("head"=>$column_head);
                                	$table_data=array("table_id"=>"data_table_1","table_data"=>$All_data);
                                  get_ajax_datatable($table_data,$show_fields,extensions_url()."events_and_venues/ui/admin/cms/ajax/datatable_ajax_organizer.php");
