...
{	
    ...
    $output=curl_post("/manage_cms",array('slug'=>$_REQUEST['slug'],'icon'=>$_REQUEST['icon'],'subtitle'=>$_REQUEST['subtitle'],'title'=>$_REQUEST['title'],'description'=>urlencode($_REQUEST['description']),'id'=>$_REQUEST['id']));
