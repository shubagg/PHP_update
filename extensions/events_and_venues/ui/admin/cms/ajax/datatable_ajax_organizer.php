...
if (!empty($searchTermsAny)) {
    ...
    $where=array('type'=>'eventorganizer');
...
foreach ( $cursor as $doc ) {
    ...
    $action_buttons.='<a data-original-title="Delete" onclick="delete_data_record(this.id)" id="data_table_1-'.$id.'" data-id="'.$id.'" class="btn btn-default btn-sm" title="">';
