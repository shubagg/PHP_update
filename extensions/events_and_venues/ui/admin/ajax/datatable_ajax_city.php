...
$where=array('stateId'=>$_GET['stateId']);
$qarray=array();
...
foreach ( $cursor as $doc ) {
    ...
    $action_buttons.='<a data-original-title="Edit" onclick="go_to_city_update_popup(\'cityaddPopup\',\''.$doc['stateId'].'\',\'id=\'+$(this).attr(\'data-id\'))" id="data_table_1-'.$id.'" data-id="'.$id.'" class="btn btn-default btn-sm" title="Edit">';
        $action_buttons.='<i class="fa fa-pencil"></i>';
    $action_buttons.='</a>&nbsp;';

    $action_buttons.='<a data-original-title="Delete" onclick="delete_data_temp_city(this.id,\''.$doc['stateId'].'\')" id="data_table_1-'.$id.'" data-id="'.$id.'" class="btn btn-default btn-sm" title="delete">';
