					...
					<div class="panel-body">
						<div>
							...
							<ul class="nav nav-tabs" role="tablist">
								<li role="presentation" onclick="load_page('pendingApprovalFormjobs','pending')" class="active"><a id="tab_pending" href="#pending" aria-controls="home" role="tab" data-toggle="tab"><?php echo $ui_string['pending'];?></a></li>
								<li role="presentation" onclick="load_page('openApprovalFormjobs','open')"><a id="tab_complete" href="#complete" aria-controls="profile" role="tab" data-toggle="tab"><?php echo $ui_string['open'];?></a></li>
								<?php /*?>
								<li role="presentation" onclick="load_page('approvedApprovalFormjobs','complete')"><a id="tab_complete" href="#complete" aria-controls="profile" role="tab" data-toggle="tab"><?php echo $ui_string['approved'];?></a></li>
								<li role="presentation" onclick="load_page('rejectedApprovalFormjobs','reject')"><a id="tab_reject" href="#reject" aria-controls="messages" role="tab" data-toggle="tab"><?php echo $ui_string['rejected'];?></a></li><?php */?>
