					...
					<div class="panel-body">
						<div>
							...
							<ul class="nav nav-tabs" role="tablist">
								...
								<li role="presentation" onclick="load_page('rejectedApprovalFormjobs','reject')"><a id="tab_reject" href="#reject" aria-controls="messages" role="tab" data-toggle="tab"><?php echo $ui_string['rejected'];?></a></li>
