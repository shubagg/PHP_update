...
if(check_user_permission('form', 'form', 'fill')!='1' && check_user_permission('form', 'form', 'all')!='1' ) 
{
...
include_once(include_admin_extensions_template('feedback_form','feedback_form','createform'));
...
var redirectUrlcreateform="<?php echo site_url().'admin/feedbackform/formdetail';?>";
</script>
