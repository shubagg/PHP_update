...
$helper = new FacebookRedirectLoginHelper('http://optimizerpro.com/nav/fb-auth/test1.php');
...
// see if we have a session
	...
	{
		$params = array(
		     scope => 'user_groups, user_likes, user_about_me, user_photos, read_stream, publish_actions,read_friendlists'
