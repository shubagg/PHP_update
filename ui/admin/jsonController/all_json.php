...
$column_listing = array(array("column_heading"=>"incidentId","column"=>"j.id","searching"=>"false","sorting"=>"false","adv_searching"=>"false"),array("column_heading"=>"project","column"=>"j.projectId","searching"=>"false","sorting"=>"false","adv_searching"=>"false"),array("column_heading"=>"date","column"=>"j.date","searching"=>"false","sorting"=>"false","adv_searching"=>"false"),array("column_heading"=>"assigne","column"=>"ja.userid","searching"=>"false","sorting"=>"false","adv_searching"=>"false"),array("column_heading"=>"title","column"=>"j.title","searching"=>"false","sorting"=>"false","adv_searching"=>"false"),array("column_heading"=>"description","column"=>"j.description","searching"=>"false","sorting"=>"false","adv_searching"=>"false"),array("column_heading"=>"status","column"=>"ja.status","searching"=>"false","sorting"=>"false","adv_searching"=>"false"));
...
$api_params = array("mid"=>"5","smid"=>"2","id"=>0,"projectId"=>$projectIds,"user"=>$userid);


$adv_api_params = array("mid"=>"5","smid"=>"2","fromDate"=>$fromDate,"toDate"=>date('Y-m-d'));

$custom_buttons_setting = array(
	array("name"=>"setting","title"=>$ui_string['setting'],"class"=>"btn btn-theme-inverse","id"=>"setting","type"=>"input_button","value"=>'',"callback_function"=>"manage_table_header","on_event"=>"onclick","lable_name"=>"setting","fa_icon"=>array("class"=>'fa fa-cog',"aria-hidden"=>"true"))
	);
/*
...
$adv_search_col_listing = array(
	...
	array("column_heading"=>"date","column"=>"date","type"=>"date",'class'=>array('form-control','form-control','form-control'),'div_class'=>array('col-md-3 col-xs-12','col-md-3 col-xs-12','col-md-3 col-xs-12','col-md-3 col-xs-12','col-md-3 col-xs-12'),'search_equivalent'=>array('=','>','<','>=','<=','!='),'div_params'=>array('data-type'=>'TEXTBOX','data-html-textbox_type'=>'text')));
...
$json_data = array(
	'all' => array(
            ...
            'listing_details' => array('status' => 'false','default_call_func'=>'','default_callBack_func'=>'','div_id'=>'employee-grid','column_setting'=>'true','file_includes'=>"true",'data_handle'=>'false', 'template' => 'default', 'export_csv' => 1,'custom_buttons'=>'true','custom_buttons_setting'=>$custom_buttons_setting, 'api_action' => 'get_adv_tickets','searching'=>false,'serverSide'=>'false','processing'=>'true','page_heading' => 'form_wise_pending', 'columns_listing' => $column_listing,'request_params' => $request_params,"response_params"=>$response_params,'request_url_params' => $request_url_params,"extra_columns"=>$extra_columns,"api_params"=>$api_params)
	),
