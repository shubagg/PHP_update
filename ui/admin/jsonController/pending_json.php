...
$custom_buttons_setting = array(array("name"=>"export","title"=>$ui_string['export'],"class"=>"btn","id"=>"export","type"=>"button","value"=>$ui_string['export'],"callback_function"=>"export_data","on_event"=>"onclick","lable_name"=>"Export"),
	array("name"=>"setting","title"=>$ui_string['setting'],"class"=>"btn","id"=>"setting","type"=>"button","value"=>$ui_string['setting'],"callback_function"=>"manage_table_header","on_event"=>"onclick","lable_name"=>"Export")
	);
