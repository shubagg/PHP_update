...
{   
    ...
    {
        $output=send_broadcast_notification(array('userId'=>$_REQUEST['users'],'ctgId'=>$_REQUEST['ctgId'],'type'=>$_REQUEST['type'],'txt'=>$_REQUEST['msg'],'tempId'=>"",'accId'=>$_REQUEST['accId'],'subject'=>$_REQUEST['subject']));
...
{	
    ...
    unset($_POST['to_min']);
    unset($_POST['to_hour']);
    unset($_POST['mailtypechoose']);

    $output=curl_post("/manage_trigger",$_POST);
