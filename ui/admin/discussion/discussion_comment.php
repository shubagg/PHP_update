...
is_user_logged_in();
 ...
 include_once(include_admin_template("discussion","discussion_comment")); ?>
...
<script type="text/javascript" src="<?php echo admin_ui_url(); ?>discussion/js/discussion_comment_manage.js"></script>
