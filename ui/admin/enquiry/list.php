...
<?php include_once(include_admin_template("enquiry","list")); ?>
...
-->
<?php 
$json_array = array("head"=>array("S.No","Name","Email","Phone","Subject","Order No.","Description"),
	                "rows"=>$stack,
...
<script type="text/javascript" src="<?php echo getAdminJsUrl('enquiry','manage_contact'); ?>"></script>
