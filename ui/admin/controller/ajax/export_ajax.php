...
$abc =array("header_fields"=>$table_headers,"show_data"=>$data);
  // echo json_encode($abc); //die;
  //  echo "<pre>"; print_r($show_data); die;

//$ex = curl_post("/DataTableExport_xls",$abc);
$ex = DataTableExport_xls($table_headers,$data);
$data['data'] = $ex;
