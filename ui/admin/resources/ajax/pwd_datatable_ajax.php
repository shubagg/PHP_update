...
foreach ($cursor as $doc) {    
    ...
    $checkbox='';
        ...
        $encryptInfo = encrypt_decrypt($id, 'encrypt', 'nikky', '');
        $encryptId = !empty($encryptInfo['data']) ? $encryptInfo['data'] : '';
        $action_buttons.='<a data-original-title="Edit" onclick="change_password(this.id)" id="'.$encryptId.'" data-id="'.$id.'" class="btn btn-default btn-sm" title="Edit">';
