                            ...
                            success: function(data) {
                               //alert(data);
                                ...
                                if(data['success']=='true')
                                {
                                    ...
                                    setTimeout(function(){ window.location=site_url+'admin/userDetail'; },1000);
                                }
                                else
                                {
                ...
                $.ajax({
                            ...
                            success: function(data) {
                                ...
                                if(data['success']=='true')
                                {
                                    $("#captcha_code").val("");
                                    $("#captcha-div").hide();
                                    setTimeout(function(){ window.location=dashboardUrl; },1000)                                                                
                                }
                              else
                              {
                                    ...
                                    /*if(data['failed_login_attempt'] >= 1)
                                    {
                                        $("#captcha-div").show();
                                        $("#captcha_code").addClass("required_field");
                                    }*/
                ...
                $.ajax({
                            ...
                            success: function(data) {
                                ...
                                if(data['success']=='true')
                                {
                                    ...
                                    $('#success_modal').modal();
                                    setTimeout(function(){ window.location=site_url+"admin"; },2000)      
                                }
                                else
                                {
                            ...
                            success: function(data) {
                               // alert(data);
                                ...
                                if(data['success']=='true')
                                {
                                    ...
                                    $('#success_modal').modal();
                                    setTimeout(function(){ $('#success_modal').modal("toggle"); },1000);
                                    setTimeout(function(){ $('#md-effect').modal("toggle"); },1000);
                ...
                $.ajax({
                            ...
                            success: function(data) {
                               //alert(data);
                                ...
                                if(data['success']=='true')
                                {
                                    setTimeout(function(){ $('#editPwd').modal("toggle"); },1000);
                ...
                $.ajax({
                            ...
                            success: function(data) {
                               //alert(data);
                                ...
                                if(data['success']=='true')
                                {
                                    setTimeout(function(){ $('#urgencyModal').modal("toggle"); },1000);
             ...
             $.ajax({
                            ...
                            success: function(data) {
                               ...
                               if(data['success']=='true')
                               {
                                ...
                                //$("#model_head").html(ui_string['confirm']);
                                //$("#model_des").html(ui_string['12078']);
                                //$('#success_modal').modal();
                                //setTimeout(function(){ $('#success_modal').modal("toggle"); },2000);
                                setTimeout(function(){ $('#eemail').css('color','red');$("#eemail").html(""); },3000);
                                ...
                                else
                                {
                                    ...
                                    //$("#model_head").html(ui_string['notconfirm']);
                                    //$("#model_des").html(ui_string['12079']);
                                    //$('#success_modal').modal();
                                    setTimeout(function(){ $("#eemail").html("");$('#success_modal').modal("toggle"); },3000);
                ...
                $.ajax({
                            ...
                            success: function(data) {
                               ...
                               data=JSON.parse(data);
                                ...
                                if(data['success']=='true')
                                {
                                    setTimeout(function(){ $('#import_modal').modal("toggle"); },2000);
