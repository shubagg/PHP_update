...
$custom_buttons_setting = array(
	array("name"=>"setting","title"=>"Setting","class"=>"btn btn-theme-inverse","id"=>"setting","type"=>"button","value"=>"setting","callback_function"=>"manage_table_header","on_event"=>"onclick","lable_name"=>"Export")
	);
/*
