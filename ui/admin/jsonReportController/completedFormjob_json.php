...
$api_params = array("mid"=>"5","smid"=>"3","userId"=>$userid, "status" => "2","hierarchy"=>"true");


$adv_api_params = array("mid"=>"5","smid"=>"3","userId"=>$userid, "status" => "2","hierarchy"=>"true");
...
$json_data = array(
	'completedFormjob' => array(
            'template' => 'completedFormjob',
            'templatePath' => '',
            'language' => 'en',
            'page_heading' => 'tickets',
            
            'advanced_search' => array('status' => 'true','adv_call_func'=>'','adv_callBack_func'=>'', 'template' => 'default', 'api_action' => 'get_extension_all_jobs','query_type'=>'mongo','page_heading' => 'advanced_search','div_class'=>'row','div_id'=>'stadd','search_equivalent'=>array('$eq','$gt','<','>=','<=','!=','like'),'adv_search_col_listing'=>$adv_search_col_listing,"api_params"=>$adv_api_params),
