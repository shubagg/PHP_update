...
$start=microtime();
global $db;
$collection = 'inventoryAllocation';
...
$where=array('allocatedTo'=>$_SESSION['user']['user_id']);
...
foreach ( $cursor as $doc ) {
    ...
    {
        $action='<button type="button" class="btn btn-theme-inverse" onclick="requestPopup(\'return_popup\',\''.$doc['productId'].'\',\''.$id.'\')"> Return </button>
                 <button type="button" class="btn btn-theme-inverse" onclick="requestPopup(\'consume_popup\',\''.$doc['productId'].'\',\''.$id.'\')"> Consume </button>';
    }
