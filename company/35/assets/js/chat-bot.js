...
var noteTextarea = "";
    noteTextarea = $('#msg');
function question() {
    document.getElementById("question").placeholder = "Speak Now.....";
    noteTextarea = $('#question');
}
function answer() {
    document.getElementById("answer").placeholder = "Speak Now.....";
    noteTextarea = $('#answer');
}
...
$('#start-record-btn, #question, #answer').on('click', function(e) {
...
function speak() {
    document.getElementById("msg").placeholder = "Speak Now.....";
}
function speakreplace(){
	document.getElementById("msg").placeholder = "Enter your message";
}
