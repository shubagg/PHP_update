...
echo $signup_tpl='<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
   ...
   <td style="height:10px;"></td>
    ...
    <tr>
	 ...
	 <table style="width:500px; margin:auto; padding:10px; border-bottom:1px solid #efefef">
			  <tr>
			    <td style="padding:10px; background:#000;"><font style="font-size:16px;color:#fff;font-size:16px;font-family:Arial,sans-serif;">Order ready for shipment</font></td>
			  </tr>
			  <!--header-end-->
			  ...
			  <tr>
				...
				<p style="padding-bottom:0px;margin-top:10px; margin-bottom:0px; padding-top:0px;font-family:Arial,sans-serif; font-size:14px;">Hello '.$final_data['jsondata']['userdata']['vendorname'].',</p></td>
			  </tr>
			  <tr>
			   <td>
			    <p style="padding-bottom:0px;padding-top:0px;font-size:14px;margin-top:10px; margin-bottom:0px; text-align:justify; line-height:20px;font-family:Arial,sans-serif;">An order is ready for shipment.</p>
			   </td>
			  </tr>
			  
			    <tr>
			   <td>
			    <p style="padding-bottom:0px;padding-top:0px;font-size:14px;margin-top:10px; margin-bottom:0px; text-align:justify; line-height:20px;font-family:Arial,sans-serif;">Order Number: '.$final_data['jsondata']['orderdata']['orderId'].'</p>
			   </td>
			  </tr>
			  ...
			  <tr>
			   <td><p style="padding-bottom:0px;padding-top:0px;font-size:14px;margin-top:10px; margin-bottom:0px; text-align:justify; line-height:20px;font-family:Arial,sans-serif;">Delivery Address:'.$final_data['jsondata']['orderdata']['address'].'</p>
			  </tr>
