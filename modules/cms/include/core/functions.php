...
function getrobotdata($data) {
    ...
    foreach ($associatedata as $key => $record) {
        ...
        $record['checkboxcolumn']='<input type="checkbox" class="check_box" id="ch_'.$record['asid'].'" name="robotId[]" value="" onclick="checkBoxCheckedMultiple(this.id,\''.$record['id'].'\',\''.$record['count'].'\')">';
...
function add_robot($data) {
    ...
    for ($i = 0; $i < $sizeoftaskaction; $i++) {
        ...
        //custom actions -->action1
        if ($data['robot'][0]['tasklist'][0]['actionlist'][$i]['action'] == 'action1') {
            $data_actions = array();
            if (isset($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['key']) && !empty($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['key'])) {
                $m = 0;
                foreach ($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['key'] as $val) {
                    unset($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['nextAction']);
                    unset($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['y_loc']);
                    $data_actions[] = array($val => $data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['value'][$m]);
                    $m++;
                }
            }
            $data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['data'] = $data_actions;
        }
        //end custom actions -->action1
        //custom actions -->action2
        if ($data['robot'][0]['tasklist'][0]['actionlist'][$i]['action'] == 'action2') {
            $data_actions = array();
            if (isset($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['key']) && !empty($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['key'])) {
                $m = 0;
                foreach ($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['key'] as $val) {
        ...
        //end custom actions -->action2
        //custom actions -->action3
        if ($data['robot'][0]['tasklist'][0]['actionlist'][$i]['action'] == 'action3') {
            $data_actions = array();
            if (isset($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['key']) && !empty($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['key'])) {
                $m = 0;
                foreach ($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['key'] as $val) {
        ...
        //end custom actions -->action3
        //custom actions -->action4
        if ($data['robot'][0]['tasklist'][0]['actionlist'][$i]['action'] == 'action4') {
            $data_actions = array();
            if (isset($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['key']) && !empty($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['key'])) {
                $m = 0;
                foreach ($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['key'] as $val) {
        ...
        //end custom actions -->action4
        //text split action
        if ($data['robot'][0]['tasklist'][0]['actionlist'][$i]['action'] == 'string_split') {
            if($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['symbol']=='custom')
            {
               $data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['symbol']=$data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['custom'];
            }
        }
        //end of text split action
                ...
                foreach ($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['action'] as $val) {
                    ...
                    if ($val == 'get_range') {
                        if ($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['get_range'][$get_range_count] == "row") {
                            ...
                            $perform_actions[] = array($val => array($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['get_range'][$get_range_count],$data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['columnname'][$columnname_count], $data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['columnvalue'][$columnname_count]));
                            $columnname_count++;
...
//end of Delete data json function
        ...
        if ($data['robot'][0]['tasklist'][0]['actionlist'][$i]['action'] == 'receive_mail') {
            ...
            {
              $data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['check_callback']="true";
            }
            else
            {
               $data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['check_callback']="false";
            }
            if(!empty($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['intends'])){
                foreach($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['intends'] as $k=>$v)
                {
                    if($v==""){
                      unset($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['intends'][$k]);  
                    }
                    $data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['intends'] = array_values($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['intends']);
                }
            }
            if (!empty($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['intends']) || !empty($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['download_attach'])) {
                $data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['check_attach'] = "true";
            }
            else
            {
    ...
    if (isset($data['id']) && $data['id'] == "0") {
        ...
        if ($res['n'] == 1) {
            ...
            for ($i = 0; $i < $sizeoftaskaction; $i++) {
                if ($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['new'] == '1') {
                    $respp = insert_mongo('ocrtemplate', array("createDate" => new MongoDate(), "asid" => $ins_id, "template_name" => $template, "new" => $newtemplate, "userId" => $createdBy,"assign_id"=>$createdBy));
                }
            }
        ...
        if ($res['n'] == 0) {
            ...
            for ($i = 0; $i < $sizeoftaskaction; $i++) {
                if ($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['new'] == '1') {
                    $resppp = insert_mongo('ocrtemplate', array("createDate" => new MongoDate(), "asid" => $ins_id, "template_name" => $template, "new" => $newtemplate, "userId" => $createdBy,"assign_id"=>$createdBy));
                }
            }
...
function template_export($data) {
    ...
    if ($check['success'] == 'true') {
        ...
        if (isset($newdata['id']) && $newdata['id'] == '0') {
            if ($newdata['new'] == '1') {
                $respp = insert_mongo('ocrtemplate', array("createDate" => new MongoDate(), "template_name" => $template, "new" => $newtemplate, "data" => $data['data'], "userId" => $userid,"assign_id"=>$userid));
            }
...
function decode_export_data($data) {
    $check = check_key_available($data, array("data","userId"));
    if ($check['success'] == 'true') {
    $query['_id'] = new MongoId($data['userId']);
    $userData = select_mongo('user', $query);
    $check_user=add_id($userData,"id");
    if(sizeof($check_user)=='1')
    {
        $userId=$data['userId'];
        $message= "";
        $type="decrypt";
        $password="nikky";
        $msg_bundle=$data['data'];
        $new_output_decrypt= encrypt_decrypt($message,$type,$password,$msg_bundle);
        $output_decrypt= str_replace("'", "",  $new_output_decrypt['data']);
        $data=json_decode($output_decrypt,TRUE);
            if (isset($data['id']) && $data['id'] == "0") {
            $title = "";
            if (isset($data['title'])) {
                $title = $data['title']; 
            ...
            if(!empty($userId))
            {
              $user_name_data= get_resource_by_id(array("id"=>$userId,"fields"=>"name"));
              if ($user_name_data['success'] == 'true') {
                $user_name = $user_name_data['data'][0]['name'];
                $uniqueid = $user_name . "_" . rand();
                $data['robot'][0]['tasklist'][0]['uniqueid']=$uniqueid;
            }
              $data['robot'][0]['tasklist'][0]['userId']= $userId;
            }
            for ($i = 0; $i < $sizeoftaskaction; $i++) {
                if (isset($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['template_name'])) {
                    $template = $data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['template_name'];
            ...
            if ($res['n'] == 1) {
                ...
                $count = 0;
                $run_time =strtotime(date('Y-m-d h:i a'));
                $res = insert_mongo('robotlistAssociate', array("createDate" => new MongoDate(), "asid" => $ins_id, "status" => "1", "runtime" => $robotno, "path" => "c:/window/rpa", "host" => "localhost", "description" => "robot 1", "name" => $title, "template_name" => $template, "userId" => $userId, "ip_address" => $ip_address,'count'=>$count,'run_time'=>$run_time, 'parent_id' => $data['parent_id'], 'map_id' => $map_id));
                for ($i = 0; $i < $sizeoftaskaction; $i++) {
                    if ($data['robot'][0]['tasklist'][0]['actionlist'][$i]['data']['new'] == '1') {
                        $respp = insert_mongo('ocrtemplate', array("createDate" => new MongoDate(), "asid" => $ins_id, "template_name" => $template, "new" => $newtemplate, "userId" => $userId));
                    }
                }
                return array("success" => "true", "data" => $ins_id, "error_code" => "470202");
            }
        }
        else
        {
    ...
    {
        return array("success" => "false", "data" => "User Doesn't Exists", "error_code" => "470209");  
    }
    } else {
        return $check;
    }
}
function add_fetch_queue_data($data) {
    if($data['action']=='fetch')
    {
        $check = check_key_available($data, array("status","machine_id","user_id"));
    }
    ...
    {
        $check = check_key_available($data, array("queue","data"));
    }
    if ($check['success'] == 'true') {
        if($data['action']=='add')
        {
            $jsondata=json_decode($data['data'],true);
                if(!empty($jsondata))
                {
                    ...
                    if(!empty($user_id))
                    {
                        ...
                        $result=select_mongo(strval($data[queue]),$query);
                        $data_result= add_id($result,"id");
                        if(sizeof($data_result)=='1')
                        {
                            $res = update_mongo(strval($data[queue]),$jsondata,array('user_id' => $user_id));
                            if ($res['n'] == '1') 
                            {
                                return array('data' => $res, 'error_code' => '45000', 'success' => 'true');
                            } 
                            else 
                            {
                                return array('data' => $res, 'error_code' => '45001', 'success' => 'false');
                            }
                        }
                        else
                        {
                           $res = insert_mongo(strval($data[queue]), $jsondata); 
                           if ($res['n'] == '0') 
                            {
                                return array('data' => $res, 'error_code' => '46000', 'success' => 'true');
                            } 
                            else 
                            {
                                return array('data' => $res, 'error_code' => '46001', 'success' => 'false');
                            }
                        }
                    }
        ...
        else if($data['action']=='fetch')
        {
            ...
            if(sizeof($data_result)=='1')
            {
                return array('data' => $data_result, 'error_code' => '49000', 'success' => 'true'); 
            }
            else 
            {
                return array('data' => $data_result, 'error_code' => '49001', 'success' => 'false');
            }
        }
        else if($data['action']=='delete')
        {
            ...
            {
                $query['user_id']=$data['user_id'];
                $res = delete_mongo(strval($data[queue]), $query);
                $res = add_id($res, "id");
                return array("success" => "true", "data" => $data['user_id'], "error_code" => "50000");
            } 
            else 
            {
                return array("success" => "false", "data" =>"", "error_code" => "50001");
            }    
        }
        else
        {
           return array('data' => $res, 'error_code' => '48000', 'success' => 'false'); 
        }      
    }
    else 
    {
...
function get_template_list($data)
{
    $query=array();
    $query['userId']=$data['userId'];
    $result=select_mongo('ocrtemplate',$query);
    $data_result= add_id($result,"id");
    $size= sizeof($data_result);
    if(!empty($data_result))
    {
        for($i=0;$i<=$size-1;$i++)
        {
            $user_name_data= get_resource_by_id(array("id"=>$data_result[$i]['assign_id'],"fields"=>"name"));
            $user_name_data=$user_name_data['data'];
            $user_size=sizeof($user_name_data);
            for($j=0;$j<=$user_size-1;$j++)
            {
                if($user_name_data[$j]['id']==$data_result[$i]['assign_id'])
                {
                  $assign_name=$user_name_data[$j]['name'];
                  $data_result[$i]['assign_name']=$assign_name;
                }
            }
            
        }
        return array('data' => $data_result, 'error_code' => '78000', 'success' => 'true'); 
    }
    else 
    {
        return array('data' => $data_result, 'error_code' => '78001', 'success' => 'false');
    }
}
// start of  inventory api
function inventory($data)
{
    logger("43", $data, "", 5, "/inventory");
    $check = check_key_available($data, array('type'));
    if($check['success'] == 'true')
    {
        if($data['type']=='add')
        {
            $check1 = check_key_available($data, array('product','sku','quantity','price','data'));
            if($check1['success'] == 'true')
            {
                if(is_numeric($data['quantity']) && is_numeric($data['price']))
                {
                    $condition=array();
                    $condition['$or']=array(array('product'=>$data['product']),array('sku'=>$data['sku']));
                    $check_exists=select_mongo('marchericche_inventory', $condition);
                    $check_exists_result= add_id($check_exists,"id");
                    $size= sizeof($check_exists_result);
                    if($size==0)
                    {
                        $data['data']= array($data['data']);
                        unset($data['type']);
                        $res = insert_mongo('marchericche_inventory', $data);
                        if ($res['n'] == 1) 
                            {
                                return array("success" => "false", "data" => $data, "error_code" => "1201");
                            } 
                            else 
                            {
                                return array("success" => "true", "data" => $data, "error_code" => "1202");
                            }
                    }
                    else
                    {
                        return array('data' => "Product is already exist.Please check your product name or product sku", 'error_code' => '1203', 'success' => 'false');
                    }
                }
                else
                {
                    return array('data' => "Only use numeric value for quantity and price", 'error_code' => '1200', 'success' => 'false');
                }
            }
            else
            {
        ...
        {
           if($data['product']!="" && $data['sku']!="")
            {
                $condition=array();
                $condition['$and']=array(array('product'=>$data['product']),array('sku'=>$data['sku']));
                $res = delete_mongo('marchericche_inventory', $condition);
                $res = add_id($res, "id");
                if ($res['1'] == sizeof($id)) {
                    return array("success" => "true", "data" => $data, "error_code" => "1225");
                } else {
                    return array("success" => "false", "data" => $data, "error_code" => "1226");
                } 
            }
            else if($data['product']!="" ||  $data['sku']!="")
            {
                $condition=array();
                $condition['$or']=array(array('product'=>$data['product']),array('sku'=>$data['sku']));
                $res = delete_mongo('marchericche_inventory', $condition);
                $res = add_id($res, "id");
                if ($res['1'] == sizeof($id)) {
                    return array("success" => "true", "data" => $data, "error_code" => "1227");
                } else {
                    return array("success" => "false", "data" => $data, "error_code" => "1228");
                } 
            }
            else
            {
                return array('data' => "", 'error_code' => '1206', 'success' => 'false');
            } 
        }
        else if($data['type']=='update')
        {
            if($data['product']!="" && $data['sku']!="")
            {
                ...
                if($size==1)
                {
                    ...
                    {
                        return array('data' => "Only use numeric value for quantity", 'error_code' => '1215', 'success' => 'false');
                    }
                    if(!is_numeric($data['price']))
                    {
                        return array('data' => "Only use numeric value for Price", 'error_code' => '1216', 'success' => 'false');
                    };
                    $data['data']= array($data['data']);
                    unset($data['type']);
                    $res = update_mongo('marchericche_inventory', $data,$condition);
                    if ($res['n'] == 1) 
                    {
                        return array("success" => "true", "data" => $data, "error_code" => "1217");
                    } 
                    else 
                    {
                        $ins_id = db_id($data);
                        return array("success" => "false", "data" => $ins_id, "error_code" => "1218");
                    }
                }
                else
                {
                   return array('data' => "Please enter valid product or sku", 'error_code' => '1220', 'success' => 'false'); 
                } 
            }
            else if($data['product']!="" ||  $data['sku']!="")
            {
                ...
                if($size>0)
                {
                    return array('data' => $check_exists_result, 'error_code' => '1204', 'success' => 'true');
                }
                else
                {
                   return array('data' => "No Data Found", 'error_code' => '1205', 'success' => 'false'); 
                }
            }
            else
            {
