...
?>
<li><?php echo $ui_string['admin'];?> </li> <li><?php echo $ui_string['attendance'];?></li><li class="active"><?php echo $ui_string['attendance_detail'];?></li></ol>
    <div id="content">
        <div class="row">
            <div class="col-lg-12">
                <!--------------------------------- Include Page Header ------------------------------------------>
        <?php 
          ...
          //include_once(include_admin_template("common_templates/attendancedetail", "page_header"));
        ?>
...
<!------------------------------ Include Listing Page -------------------------------------->
            ...
            <?php 
                ...
                {
                   include_once(include_admin_template("common_templates/attendancedetail", "listing1"));
                }
            ?>
