         ...
         <script>
			...
			<div id="content">
                ...
                <div class="row">
                        ...
                        <?php if(check_user_permission("notification","notification1","triggerAll")==1) { ?>	



                            <a href="AddTrigger">

          <div class="custom_button btn_cu btn btn-default" data-toggle="popover" data-placement="left" data-content="<?php echo $ui_string['clk_add_trigger'];?>" data-original-title="<?php echo $ui_string['add_trigger'];?>"> <span><?php echo $ui_string['add'];?></span> </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								...
								<h3><strong><?php echo $ui_string['man'];?></strong> <?php echo $ui_string['trigger'];?></h3>
...
<input type="checkbox" id="check11" onClick="checkall();" class="all_check" />
                ...
                <label for="check11" class="lighter select-color" ><?php echo $ui_string['sel_all'];?></label>
						...
						<label class="lighter" for="check11" style="display:initial"><?php echo $ui_string['sel_all']; ?></label>
						 ...
						 <button type="button" onClick="delete_trigger_temp()" class="btn btn-default" data-toggle="tooltip" data-placement="top" title="Delete"><i class="glyphicon glyphicon-trash"></i> <!--<?php echo $ui_string['delete']; ?>--></button>
        ...
        <div class="panel-body">
					        	...
					        	<div class="table-responsive">
                                    ...
                                    if(check_user_permission("notification","notification1","triggerAll")==1) 

                                    { 

                                        $column_head=array('checkbox','Module Name','Sub Module','Event Name','Subject','Push Title','Type','Action');  

                                        $show_fields=array('checkbox','mid','smid','eid','subject','msg','type','action');
...

                                    {
                                        ...
                                        $column_head=array('Module Name','Sub Module','Event Name','Subject','Push Title','Type');  

                                        $show_fields=array('mid','smid','eid','subject','msg','type');   
                                    ...
                                    get_ajax_datatable($table_data,$show_fields,admin_ui_url()."notification/ajax/trigger_datatable_ajax.php"); 
    ...
    <h4 class="modal-title" id="model_head"> <i class="glyphicon glyphicon-ok-circle"></i> <?php echo $ui_string['confirmation'];?> </h4>
