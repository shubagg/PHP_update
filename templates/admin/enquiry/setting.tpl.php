      ...
      <form id="reportrecord" class="form-horizontal" method="post" action="" enctype="multipart/form-data">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
              <label for="inputOne" class="biglable" dir="rtl" lang="ar">English</label>
            </div>
...
<span id="report3" style="color:red"></span>
                                                                ...
                                                                <div class="form-group">
																		<label for="inputOne">PASSWORD</label>
																				<input type="text" class="form-control" id="inputOne">
<span id="report3" style="color:red"></span>
																</div>
                                                                
                                                                <div class="form-group">
																		<label for="inputOne">SERVER</label>
																				<input type="text" class="form-control" id="inputOne">
<span id="report3" style="color:red"></span>
																</div>
                                                                
                                                                <div class="form-group">
																		<label for="inputOne">PORT</label>
																				<input type="text" class="form-control" id="inputOne">
<span id="report3" style="color:red"></span>
																</div>
                                                                
                                                                <div class="form-group">
																		<label for="inputOne">SSL</label>
...
<span id="report3" style="color:red"></span>
                ...
                <div class="form-group">
				  <button  type="button" class="btn btn-theme-inverse"> Save </button>
      ...
      <section class="box">
             <h2 class="title">SOCIAL MEDIA INFO</h2>
		...
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
              <label for="inputOne" class="biglable">English </label>
                ...
                <div class="form-group">
																		<label for="inputOne">FACEBOOK URL  </label>
																				<input type="text" class="form-control" id="inputOne">
<span id="report3" style="color:red"></span>
																</div>
					...
					<div class="form-group">
							<label for="inputOne">TWITTER URL</label>
								<input type="text" class="form-control" id="inputOne">
<span id="report5" style="color:red"></span>
					...
					<div class="form-group">
							<label for="inputOne">GOOGLE PLUS URL</label>
								<input type="text" class="form-control" id="inputOne">
<span id="report5" style="color:red"></span>
						</div>
					...
					<div class="form-group">
							<label for="inputOne">WEBSITE URL </label>
								<input type="text" class="form-control" id="inputOne">
<span id="report5" style="color:red"></span>
						</div>	
