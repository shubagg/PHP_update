					...
					<div class="panel-body">
						...
						<?php if($stores['success']=='true'){ ?>
							...
							<ul class="nav nav-tabs" role="tablist">
								<li role="presentation" onclick="load_page('inventoryRequest','request_stock')" class="active"><a id="tab_request_stock" href="#request_stock" aria-controls="home" role="tab" data-toggle="tab">Requested Stock</a></li>
								<li role="presentation" onclick="load_page('inventoryStockin','stock_in')"><a id="tab_stock_in" href="#stock_in" aria-controls="profile" role="tab" data-toggle="tab">Stock In</a></li>
								<li role="presentation" onclick="load_page('inventoryStockout','stock_out')"><a id="tab_stock_out" href="#stock_out" aria-controls="messages" role="tab" data-toggle="tab">Stock Out</a></li>
								<li role="presentation" onclick="load_page('inventoryReturn','reurned_stock')"><a id="tab_reurned_stock" href="#reurned_stock" aria-controls="settings" role="tab" data-toggle="tab">Returned Stock</a></li>
								<li role="presentation" onclick="load_page('inventoryAvailable','avail_stock')"><a id="tab_avail_stock" href="#avail_stock" aria-controls="settings" role="tab" data-toggle="tab">Available Stock</a></li>
							</ul>
							<!-- Tab panes -->
	...
	<div id="manage_allocation_modal" class="modal fade" role="dialog">
		...
		<div class="modal-body">
			<form method="post" id="allocation_form">
				<div class="form-group row">
					<div class="col-md-12">
						<label class="control-label"> Category </label><em>*</em>
				...
				<div class="form-group row">
					<div class="col-md-12">
						<label class="control-label"> Item Name </label><em>*</em>
				...
				<div class="form-group row">
					<div class="col-md-12">
						<label class="control-label">Allocate To </label><em>*</em>
