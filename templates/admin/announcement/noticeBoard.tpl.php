...
function checkalldata(){}
			...
			<div id="content">
                ...
                <header class="panel-heading">
                        <h3><strong><?php echo $ui_string['noticeBoard'];?></strong> </h3>
                    </header>
                
						<div class="panel-body panel_bg_d">
							<div class="table-responsive">
                            <?php 
                            if(check_user_permission("announcement","announcement","all")==1){
                                $column_head=array($ui_string['date'],$ui_string['type'],$ui_string['title'],$ui_string['description'],$ui_string['action']);  
                                $show_fields=array('date','type','title','txt','action');
                            }
                            else{
                                $column_head=array($ui_string['date'],$ui_string['type'],$ui_string['title'],$ui_string['description']);  
                                $show_fields=array('date','type','title','txt');
                            }
                            ...
                            //get_admin_datatable($table_data);
                             ...
                             if(check_user_permission("announcement","announcement","all")==1 || check_user_permission("announcement","announcement","view")==1){
                                 get_ajax_datatable($table_data,$show_fields,admin_ui_url()."announcement/ajax/notice_datatable_ajax.php"); 
                                }
