...
<ol class="breadcrumb">
	...
	<section class="panel">
    <div class="display_block" onclick="export_data('admin')">
			...
			<div class="panel-body " id="reportdata">
				...
				<?php 
                    ...
                    $column_head=array($ui_string['name'],'Total Devices','Used Devices');  
         			$show_fields=array('name','total_devices','used_devices');
                    ...
                    get_ajax_datatable($table_data,$show_fields,admin_ui_url()."resources/ajax/datatable_ajax.php?user_type=admin&ucheck=report"); 
